...
const TIERS = ['casual', 'editorial', 'hot', 'xxx'];
const ESTADOS = ['borrador', 'prueba', 'publicada'];
 ...
 */
function validarCategoria(cat, idsExistentes = []) {
  const problemas = [];
  const c = cat || {};
...
function previsualizar(texto, nombres) {
